...
namespace ipc {
    ...
    template __host__ __device__ float point_line_distance<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& e0,
        const glm::tvec3<float>& e1);

    template __host__ __device__ double point_line_distance<double>(
    ...
    template __host__ __device__ Vector<float, 9> point_line_distance_gradient<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& e0,
        const glm::tvec3<float>& e1);

    template __host__ __device__ Vector<double, 9> point_line_distance_gradient<double>(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& e0,
        const glm::tvec3<double>& e1);
    ...
    template __host__ __device__ Matrix9<float> point_line_distance_hessian<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& e0,
        const glm::tvec3<float>& e1);

    template __host__ __device__ Matrix9<double> point_line_distance_hessian<double>(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& e0,
        const glm::tvec3<double>& e1);
    ...
    namespace autogen {
        ...
        __host__ __device__ void point_line_distance_gradient_2D(
            ...
            Scalar g[6])
        {
            Scalar t13, t14, t23, t25, t24, t26, t27;
        ...
        __host__ __device__ void point_line_distance_gradient_3D(
            ...
            Scalar g[9])
        {
            Scalar t17, t18, t19, t20, t21, t22, t23, t24, t25, t42, t44, t45, t46,
                t43, t50, t51, t52;
        ...
        __host__ __device__ void point_line_distance_hessian_2D(
            ...
            Scalar H[36])
        {
            Scalar t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t31, t34, t32,
        ...
        __host__ __device__ void point_line_distance_hessian_3D(
            ...
            Scalar H[81])
        {
            Scalar t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t35,
