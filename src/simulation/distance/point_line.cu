...
namespace ipc {
    ...
    template float __device__ point_line_distance<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& e0,
        const glm::tvec3<float>& e1);

    template double __device__ point_line_distance<double>(
    ...
    template Vector<float,9> __device__ point_line_distance_gradient<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& e0,
        const glm::tvec3<float>& e1);

    template Vector<double,9> __device__ point_line_distance_gradient<double>(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& e0,
        const glm::tvec3<double>& e1);
