...
namespace ipc {
    ...
    template __device__ float line_line_distance<float>(
        const glm::tvec3<float>& ea0,
        const glm::tvec3<float>& ea1,
        const glm::tvec3<float>& eb0,
        const glm::tvec3<float>& eb1);

    template __device__ double line_line_distance<double>(
         ...
         const glm::tvec3<Scalar>& eb1)
     {
        ...
        template __device__ Vector12<float> line_line_distance_gradient(
            const glm::tvec3<float>& ea0,
            const glm::tvec3<float>& ea1,
            const glm::tvec3<float>& eb0,
            const glm::tvec3<float>& eb1);

        template __device__ Vector12<double> line_line_distance_gradient(
            const glm::tvec3<double>& ea0,
            const glm::tvec3<double>& ea1,
            const glm::tvec3<double>& eb0,
            const glm::tvec3<double>& eb1);
