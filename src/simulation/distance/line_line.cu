...
namespace ipc {
    ...
    {
        const glm::tvec3<Scalar> normal = glm::cross(ea1 - ea0, eb1 - eb0);
        const Scalar line_to_line = glm::dot(eb0 - ea0, normal);
        return line_to_line * line_to_line / glm::length2(normal);
    }

    template __host__ __device__ float line_line_distance<float>(
        const glm::tvec3<float>& ea0,
        const glm::tvec3<float>& ea1,
        const glm::tvec3<float>& eb0,
        const glm::tvec3<float>& eb1);

    template __host__ __device__ double line_line_distance<double>(
    ...
    template __host__ __device__ Matrix12<float> line_line_distance_hessian(
        const glm::tvec3<float>& ea0,
        const glm::tvec3<float>& ea1,
        const glm::tvec3<float>& eb0,
        const glm::tvec3<float>& eb1);

    template __host__ __device__ Matrix12<double> line_line_distance_hessian(
        const glm::tvec3<double>& ea0,
        const glm::tvec3<double>& ea1,
        const glm::tvec3<double>& eb0,
        const glm::tvec3<double>& eb1);
    ...
    namespace autogen {
        ...
        __host__ __device__  void line_line_distance_gradient(
            ...
            Scalar g[12])
        {
            Scalar t11, t12, t13, t14, t15, t16, t17, t18, t19, t32, t33, t34, t35,
        ...
        __host__ __device__ void line_line_distance_hessian(
            ...
            Scalar H[144])
        {
            Scalar t11, t12, t13, t14, t15, t16, t26, t27, t28, t47, t48, t49, t50,
