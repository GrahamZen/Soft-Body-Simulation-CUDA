...
namespace ipc {
    ...
    template __host__ __device__ float point_plane_distance<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& origin,
        const glm::tvec3<float>& normal);

    template __host__ __device__ double point_plane_distance<double>(
    ...
    template __host__ __device__ Vector12<double> point_plane_distance_gradient(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& t0,
        const glm::tvec3<double>& t1,
        const glm::tvec3<double>& t2);
