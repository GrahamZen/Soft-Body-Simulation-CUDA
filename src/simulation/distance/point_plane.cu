...
namespace ipc {
    ...
    template __device__ float point_plane_distance<float>(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& origin,
        const glm::tvec3<float>& normal);

    template __device__ double point_plane_distance<double>(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& origin,
        const glm::tvec3<double>& normal);
    ...
    {
        return point_plane_distance(p, t0, glm::cross(t1 - t0, t2 - t0));
    }
    ...
    template __device__ Vector12<float> point_plane_distance_gradient(
        const glm::tvec3<float>& p,
        const glm::tvec3<float>& t0,
        const glm::tvec3<float>& t1,
        const glm::tvec3<float>& t2);

    template __device__ Vector12<double> point_plane_distance_gradient(
        const glm::tvec3<double>& p,
        const glm::tvec3<double>& t0,
        const glm::tvec3<double>& t1,
        const glm::tvec3<double>& t2);
    ...
    namespace autogen {
        ...
        __device__ void point_plane_distance_gradient(
            ...
            Scalar g[12])
        {
            Scalar t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t32,
        ...
        void point_plane_distance_hessian(
            ...
            Scalar H[144])
        {
            Scalar t11, t12, t13, t18, t20, t22, t23, t24, t25, t26, t27, t28, t65,
