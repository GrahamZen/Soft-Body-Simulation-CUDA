...
template void sort_coo(int N, int& nz, float* d_A, int* d_rowIdx, int* d_colIdx, float*& new_A, int*& new_rowIdx, int*& new_colIdx);
template void sort_coo(int N, int& nz, double* d_A, int* d_rowIdx, int* d_colIdx, double*& new_A, int*& new_rowIdx, int*& new_colIdx);