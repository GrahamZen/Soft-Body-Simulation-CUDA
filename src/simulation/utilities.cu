...
__global__ void populateBVHNodeAABBPos(BVHNode* nodes, glm::vec3* pos, int numNodes) {
    ...
    pos[idx * 24 + 0] = glm::vec3(aabb.min.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 1] = glm::vec3(aabb.min.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 2] = glm::vec3(aabb.min.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 3] = glm::vec3(aabb.max.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 4] = glm::vec3(aabb.max.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 5] = glm::vec3(aabb.max.x, aabb.min.y, aabb.max.z);
    pos[idx * 24 + 6] = aabb.max;
    pos[idx * 24 + 7] = aabb.max;
    pos[idx * 24 + 8] = aabb.max;
    pos[idx * 24 + 9] = glm::vec3(aabb.min.x, aabb.max.y, aabb.max.z);
    pos[idx * 24 + 10] = glm::vec3(aabb.min.x, aabb.max.y, aabb.max.z);
    pos[idx * 24 + 11] = glm::vec3(aabb.min.x, aabb.max.y, aabb.max.z);
    pos[idx * 24 + 12] = aabb.min;
    pos[idx * 24 + 13] = aabb.min;
    pos[idx * 24 + 14] = aabb.min;
    pos[idx * 24 + 15] = glm::vec3(aabb.max.x, aabb.min.y, aabb.min.z);
    pos[idx * 24 + 16] = glm::vec3(aabb.max.x, aabb.min.y, aabb.min.z);
    pos[idx * 24 + 17] = glm::vec3(aabb.max.x, aabb.min.y, aabb.min.z);
    pos[idx * 24 + 18] = glm::vec3(aabb.max.x, aabb.max.y, aabb.min.z);
    pos[idx * 24 + 19] = glm::vec3(aabb.max.x, aabb.max.y, aabb.min.z);
    pos[idx * 24 + 20] = glm::vec3(aabb.max.x, aabb.max.y, aabb.min.z);
    pos[idx * 24 + 21] = glm::vec3(aabb.min.x, aabb.max.y, aabb.min.z);
    pos[idx * 24 + 22] = glm::vec3(aabb.min.x, aabb.max.y, aabb.min.z);
    pos[idx * 24 + 23] = glm::vec3(aabb.min.x, aabb.max.y, aabb.min.z);
}