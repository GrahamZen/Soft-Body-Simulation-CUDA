...
template colliPrecision ccdCollisionTest<double>(const Query& query, const glm::tvec3<double>* Xs, const glm::tvec3<double>* XTildes, glmVec3& n);
template colliPrecision ccdCollisionTest<float>(const Query& query, const glm::tvec3<float>* Xs, const glm::tvec3<float>* XTildes, glmVec3& n);
